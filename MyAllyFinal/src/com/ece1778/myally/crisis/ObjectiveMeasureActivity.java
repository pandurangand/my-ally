...
import com.ece1778.myally.MainActivity;
 ...
 */
public class ObjectiveMeasureActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.obj_measure);
 		...
 		t4.schedule(new TimerTask() {
 			...
 			public void run() {
 				...
 				if (b.containsKey(ActivityEntry.COLUMN_POST_MOOD)) {
 					...
 					String crisisActivity = db.getCrisis();
 					Log.d("from databaes it looks tob e", crisisActivity);
 					TherapyManager tm = new TherapyManager();
        ...
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            if (imgAvg < rollingAverage) {
                ...
                if (newType != currentType) {
                    beats++;
                    image.setImageResource(R.drawable.heart_on);
                    // Log.d(TAG, "BEAT!! beats="+beats);
                }
            } else if (imgAvg > rollingAverage) {
                newType = TYPE.GREEN;
                if (newType != currentType) {
                	image.setImageResource(R.drawable.heart_off);
                }
            }
