...
public class InfoDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
        "CREATE TABLE IF NOT EXISTS " + ActivityEntry.TABLE_NAME + " (" +
        		ActivityEntry._ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
        		ActivityEntry.COLUMN_DATE + TEXT_TYPE + 
        " )";
    
    private static final String SQL_CREATE_CRISIS_ENTRY =
            "CREATE TABLE IF NOT EXISTS " + ActivityEntry.TABLE_NAME + " (" +
            		CrisisEntry._ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
    ...
    private static final String SQL_DELETE_CRISIS_ENTRIES =
            "DROP TABLE IF EXISTS " + CrisisEntry.TABLE_NAME;
	...
	public String getCrisis() {
		...
		Cursor cursor = db.query(CrisisEntry.TABLE_NAME, CrisisEntry.COLUMNS, " id = ?", null, null, null, null, null);
